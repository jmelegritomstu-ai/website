<?php $branch = "Paranaque"; ?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>MZE Paranaque | Employee Tracking</title>
...
<body>
  <div class="container">
    <h2>MZE Paranaque Branch Employees</h2>
    <div class="table-responsive">
      <table class="table table-bordered align-middle text-center">
        <thead class="table-dark"><tr><th>Photo</th><th>Name</th><th>Job Position</th><th>Work Schedule</th><th>Age</th><th>Contact No.</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody></tbody>
      </table>
    </div>
  </div>
