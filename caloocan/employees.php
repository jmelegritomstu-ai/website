...
$sql = "SELECT id, employee_id, name, secondary_branch, job_position, work_schedule, age, contact_no, status, image FROM caloocan ORDER BY id DESC";
  ...
  <div class="sidebar">
    <div>
      ...
      <div class="nav-links">
        ...
        <a href="capstone/analytics.php" class="active">Analytics</a>
        <a href="#">Inventory</a>
        <a href="#">Settings</a>
      </div>
    </div>
